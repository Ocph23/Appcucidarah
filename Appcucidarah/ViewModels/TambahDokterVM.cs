...
{
    class TambahDokterVM:Models.Data.dokter,IDataErrorInfo
    {
        #region properties
        ...
        #region Constructor
        public TambahDokterVM()
        {
            this.Load();
            this.Kontak = new kontak { TipeKontak = ContactType.Dokter };
            this.IsNew = true;
        ...
        public TambahDokterVM(dokter selected)
        {
            this.Load();
        ...
        private void SaveCommandAction(object obj)
        {
            ...
            var dokterContext = Helper.GetMainContex().Doctors;
